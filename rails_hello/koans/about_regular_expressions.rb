...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional
    ...
    assert_equal "ab", "abbcccddddeeeee"[/abz?/]
  end
  ...
  def test_character_classes_give_options_for_a_character
    ...
    assert_equal ["cat"], animals.select { |a| a[/[c]at/] }
  end
  ...
  def test_shortcut_character_classes_are_negated_with_capitals
    ...
    assert_equal " = ", "variable_1 = 42"[/[^a-zA-Z0-9_]+/]  # GJ likely to understand better
  ...
  def test_dollar_sign_anchors_to_the_end_of_lines
    assert_equal "1234", "2 lines1234\nnum 42"[/\d+$/]
  end

  def test_slash_b_anchors_to_a_word_boundary
    assert_equal "vines", "bovine vines"[/\bvine./] # GJ ?
  end
  ...
  def test_parentheses_also_capture_matched_content_by_number # GJ useful
  ...
  def test_sub_is_like_find_and_replace
    assert_equal "one t-three", "one two-three".sub(/(t\w*)/) { $1[0, 1] }  # GJ ?
  end
