...
class AboutIteration < Neo::Koan
  ...
  def test_iterating_with_each
    array = [1, 2, 3]
    sum = 0
    array.each do |item| # GJ weird syntax....
      sum += item
    end
    assert_equal 6, sum
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    assert_equal 72, result2

    # Extra Credit:
    # Describe in your own words what inject does.
    # Put a temporary item into the array, then do the array manipulation.
  end
  ...
  #   # code to read 'file'
  #
  #   File.open("filename.txt") do |file| only proceed when opening file correctly.
  #
  #
